...
public class EasyAI : MonoBehaviour
{
    ...
    public static void Jump(Pieces[,] pieces, List<Pieces> forcedPieces)
    {
        ...
        if (pieces[x, y] != null && pieces[x, y].isPlayer1Color == false && pieces[x, y].isDama == false)
        {
            ...
            {
                if (pieces[x - 1, y - 1] != null && pieces[x - 1, y - 1].isPlayer1Color && x > 1 && y > 1) //pag may piece ung katabi -l
                {
            ...
            {
                if (pieces[x + 1, y - 1] != null && pieces[x + 1, y - 1].isPlayer1Color && x < 6 && y > 1) //pag may space ung katabi -r
                {
                    if (pieces[x + 2, y - 2] == null)
                    {
                        x1 = x;
            ...
            else //both sides
            {
                ...
                else if (pieces[x + 1, y - 1] != null && pieces[x + 1, y - 1].isPlayer1Color && x < 6 && y > 1) //pag may space ung katabi -r
                {
                    if (pieces[x + 2, y - 2] == null)
                    {
                        x1 = x;
        ...
        else
        {
            ...
            if (x == 7) //kaliwa lang pwede
            {
                if (pieces[x - 1, y + 1] != null && pieces[x - 1, y + 1].isPlayer1Color && x > 0 && (y < 7 && y >= 0)) //pag may piece ung katabi -l
                {
                    if (pieces[x - 2, y + 2] == null)
                    {
                        x1 = x;
                ...
                else if (pieces[x - 1, y - 1] != null && pieces[x - 1, y - 1].isPlayer1Color && x > 1 && (y < 7 && y > 1)) //pag may piece ung katabi -l
                {
                    if (pieces[x - 2, y - 2] == null)
                    {
                        x1 = x;
            ...
            {
                if (pieces[x + 1, y + 1] != null && pieces[x + 1, y + 1].isPlayer1Color && x < 6 && (y < 6  && y > 0 )) //pag may space ung katabi -r
                {
                    if (pieces[x + 2, y + 2] == null)
                    {
                        x1 = x;
                ...
                else if (pieces[x + 1, y - 1] != null && pieces[x + 1, y - 1].isPlayer1Color && x < 6 && (y <= 7 && y > 0)) //pag may space ung katabi -r
                {
                    if (pieces[x + 2, y - 2] == null)
                    {
                        x1 = x;
            ...
            {
                if (pieces[x - 1, y + 1] != null && pieces[x - 1, y + 1].isPlayer1Color && x > 1 && (y < 6 && y >= 0 )) //pag may piece ung katabi -l
                {
                    if (pieces[x - 2, y + 2] == null)
                    {
                        x1 = x;
                ...
                if (y > 0)
                {
                    if (pieces[x - 1, y - 1] != null && pieces[x - 1, y - 1].isPlayer1Color && x > 1 && (y <= 7 && y > 0))
                    {
                        if (pieces[x - 2, y - 2] == null)
                        {
                            x1 = x;
                    ...
                    if (pieces[x + 1, y - 1] != null && pieces[x + 1, y - 1].isPlayer1Color && x < 6 && (y <= 7 && y > 0))
                    {
                        if (pieces[x + 2, y - 2] == null)
                        {
                            x1 = x;
                ...
                if (pieces[i, j] == randomSelectedPiece)
                {
                    ...
                    else // both
                    {
                        if (pieces[i, j].isDama)
                        {
                            ...
                            else if (pieces[i + 1, j + 1] == null && j < 7)
                            {
                                int random = Random.Range(0, 1);
                                if (random == 0)
                                {
